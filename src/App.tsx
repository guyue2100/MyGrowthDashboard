  ...
  return (
    <div className="min-h-screen pb-10 md:pb-20 pt-6 md:pt-12">
      ...
      <main className="max-w-5xl mx-auto px-4 md:px-6 grid grid-cols-1 lg:grid-cols-12 gap-6 md:gap-10">
        ...
        {/* 右侧：结果展示与保存区域 */}
        <div id="report-area" className="lg:col-span-7 space-y-10 bg-slate-50/50 p-4 rounded-[3rem]">
          {latestRecord && (
              ...
              <div className="bg-zinc-50/50 p-6 rounded-2xl border border-zinc-100">
                ...
                <ul className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <li className="bg-blue-50/50 p-4 rounded-xl border border-blue-100">
                    <span className="block text-xs text-blue-400 font-bold mb-1">男孩</span>
                    <span className="font-mono text-blue-700 font-bold text-xs">(父高 + 母高 + 13) / 2 ± 6.5 cm</span>
                  </li>
                  <li className="bg-pink-50/50 p-4 rounded-xl border border-pink-100">
                    <span className="block text-xs text-pink-400 font-bold mb-1">女孩</span>
                    <span className="font-mono text-pink-700 font-bold text-xs">(父高 + 母高 - 13) / 2 ± 6.5 cm</span>
                  </li>
                </ul>
              </div>
